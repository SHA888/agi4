...
pub fn render(verdict: &VerdictOutput) -> String {
    ...
    output.push_str(&format!("# AGI/4 Attestation Verdict\n\n"));
    output.push_str(&format!("**Model:** {}\n", verdict.model.id));
    output.push_str(&format!("**Specification Version:** {}\n", verdict.spec_version));
    ...
    output.push_str(&render_conjunct_section("Generality", &verdict.conjuncts.generality));
